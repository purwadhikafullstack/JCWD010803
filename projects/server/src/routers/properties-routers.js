...
router.post('/',verifyToken, multerUpload(path.join(__dirname, "../../public/property"), 'property').single("file"), checkProperty, propertiesController.addProperty)
...
router.patch('/:id', multerUpload(path.join(__dirname, "../../public/property"), 'property').single("file"),checkProperty ,propertiesController.updateProperty)
