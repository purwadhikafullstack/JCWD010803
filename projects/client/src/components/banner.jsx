...
const Banner = () => {
  return (
    <div className="relative bg-cover bg-center h-auto text-white py-56 px-auto object-fill">
      <img src={BannerImage} alt="Banner" className="object-cover w-full h-auto" />
      <div className="absolute top-0 right-0 md:w-full flex justify-end items-center h-full md:pr-8 pr-4"> {/* Added pr-4 for smaller screens and pr-8 for larger screens */}
        <a
          href="#/"
