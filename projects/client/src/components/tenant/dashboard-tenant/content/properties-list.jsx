...
export const MyProperties = ({ setConfirmOpen, reload, setOpen, location, propertyCategory, propertyName, propertyDesc, id, propertyImg }) => {
  ...
  return (
    <div>
      <div className=" text-3xl w-full flex sm:justify-start justify-center text-teal-700 pb-3">My Properties</div>
      <div className=" mt-2 h-12 items-center text-gray-700 flex justify-center sm:justify-between ">
        <div className='flex w-3/4 gap-5'>
          ...
          <div
            className="p-2 hidden sm:block bg-bgPrimary rounded-lg text-white font-thin cursor-pointer hover:scale-95" onClick={toCalendar}
          >
            Do you want to see your available properties?
          </div>
        ...
        <div className="flex gap-5">
          <div class=" flex items-center space-x-2">
            ...
            />
            <label for="1" class="text-gray-700">
              Latest
            </label>
          </div>
          |
          <div class="flex items-center space-x-2">
            ...
            />
            <label for="DESC" class="text-gray-700">
              Newest
            </label>
          </div>
        </div>
            ...
            <div className=" hover:scale-105 transition-all cursor-pointer border mb-5 sm:flex block sm:w-full sm:h-44 h-fit rounded-lg">
              ...
              <div className="my-auto sm:px-10 w-full pb-5 sm:pb-0 ">
                <div
                  ...
                  className=" w-full"
                >
                  <div className=" sm:px-0 px-2 text-xl font-semibold text-gray-800">
                    {" "}
                    {item.propertyName}{" "}
                  </div>
                  <div className=" sm:px-0 px-2 text-sm text-gray-600">
                    {" "}
                    {item.category.category}{" "}
                  </div>
                  <div className=" sm:px-0 px-2 mt-2 w-3/4 block xl:hidden text-gray-700">
                    {" "}
                    {item.propertyDesc.slice(0, 70) + "..."}{" "}
                  </div>
                  <div className=" sm:px-0 px-2 mt-2 lg:w-3/4 w-full hidden xl:block text-gray-700">
                    {" "}
                    {item.propertyDesc.slice(0, 170) + "..."}{" "}
                  </div>
                </div>
