                    ...
                    <div className="w-2/4 h-5/6">
                        ...
                        >
                            ...
                            <div className="w-full ">
                                <div className=" text-4xl flex justify-center text-gray-800">Write a description for your property</div>
                                <div className=" text-xl flex justify-center mt-5 text-gray-600">Share what makes your place special.</div>
                            </div>
                        </motion.div>
                        <motion.div
                            ref={ref}
                        ...
                        >
                            <div className="mt-10 p-10">
                                <textarea
                                    type="text"
                                    className=" border-gray-600 text-2xl p-5 border rounded-xl w-full h-60"
                                    onChange={(e) => {
