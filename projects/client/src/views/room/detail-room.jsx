  ...
  const toBooking = () => {
    if (!token) {
      ...
      if (!userData.isVerified) {
        ...
        navigate(
          `/book?checkIn=${checkInDate}&checkOut=${checkOutDate}&totalPayment=${
            rangeDate * data.price
          }&roomId=${id}`
        );
        window.scrollTo(0, 0);
      }
          ...
          <div className="w-full px-20 h-3/4 mt-10">
            <div className="w-full gap-2 flex">
              <img
                ...
                src={`${process.env.REACT_APP_API_IMG_URL}/room/${
          ...
          <div className="w-full lg:px-20 px-10 gap-10 lg:flex block mt-10">
                          ...
                          <div className=" mt-5 w-1/2 text-gray-600">
                            <div className="flex gap-2 items-center">
                              {item.userTransaction.user.profileImg ? (
                                ...
                                <div
                                  className={` w-14 flex justify-center items-center h-14 rounded-full ${getRandomColor()}`}
                                >
                                  {
            ...
            <div className=" lg:mt-0 mt-5 w-full lg:w-2/5 h-fit py-5 border rounded-xl shadow-md">
              <div>
                ...
                <div
                  className={`px-5 mt-2 text-sm  text-gray-400 ${
                    data.availableRooms ? "flex" : "hidden"
                  }`}
                >
                  {`Sorry, this room is not available from ${
                    data.availableRooms
