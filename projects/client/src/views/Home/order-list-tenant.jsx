...
export const OrderList = () => {
    ...
    return (
        <div className="flex h-screen overflow-hidden">
            <DetailOrderModal data={data} setOpen={setOpen} orderId={orderId} open={open}  />
            {/* Sidebar */}
            ...
            <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
                ...
                <div> <OrderListComponent setOpen={setOpen} setDetail={setData} setOrderId={setOrderId} /> </div>
            </div>
        </div>
    )
}